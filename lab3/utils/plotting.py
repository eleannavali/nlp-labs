...
def plot_training_curves(tr_loss, tr_acc, val_loss, val_acc,name,model,batch_size,epochs,concat,bidirectional):
    ...
    plt.savefig('diagrams/loss/'+name+'_'+model+"_batch_size="+str(batch_size)+"_epochs="+str(epochs)+"_concat="+str(concat)+"_bidirectional="+str(bidirectional)+'.png')
    ...
    plt.legend(fontsize=11)
    plt.savefig('diagrams/accuracy/'+name+'_'+model+"_batch_size="+str(batch_size)+"_epochs="+str(epochs)+"_concat="+str(concat)+"_bidirectional="+str(bidirectional)+'.png')
