...
#     cnt=0
#     print(data.feats.shape,len(data.labels),len(data.uttids),len(data.end_indices))
#     # print(data[0][0].shape, data.labels[0:data.end_indices[0]],data[0][1])
#     l=set()
