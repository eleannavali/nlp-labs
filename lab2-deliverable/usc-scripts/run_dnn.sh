...
DATA_PATH=/home/eleanna/Desktop/master/nlp/nlp-labs/kaldi/egs/usc/data/test
...
bash utils/decode_dnn.sh $GRAPH_PATH $DATA_PATH $TEST_ALI_PATH $OUT_DECODE_PATH "cat $DNN_OUT_FOLDER/posteriors.ark"
